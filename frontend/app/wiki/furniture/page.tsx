...
export default function FurniturePage(){return <WikiPage lastModified="2026-09-18" title="Interactive Furniture" intro="Furniture gives cooking tools and display pieces a physical place in the world. Pieces can rotate, hold items, and in some cases be carried." width="lg">
