...
export default function GunsPage(){return <WikiPage lastModified="2026-09-12" title="Guns & Gunsmithing" intro="Musketeers assemble rifles, pistols, shotguns and launchers from a barrel, loader, chamber, action and, where required, a stock." width="lg">
