...
| [`frontend/app/map/editor/`](../../frontend/app/map/editor/) | Staff map title editor (`/map/editor?map=…`; enter via **Edit titles** on map viewer) |
...
2. **Wars** — [war-build-order.md](./war-build-order.md): **step 56** foundation **done**; **step 57** pathfinder & campaign **done**; **step 58** initiative & occupation **done**; **step 59** battle scheduling **done**; **60+** planned; declare codes **step 68** (last). PS map layer **step 44** after SF **67**.
