...
Character creator **done** (through step-30). Drink Builder **done** (step-31). Realm gateway **done** (steps 32–35). Map site UX **done** (step-37, code). Parchment pipeline v1 **done** (step-38, code). Ink cartography **done** (step-39, code). **Next product work:** [step-40 curved labels](./batches/step-40/00-index.md) ([16-map-platform.md](./16-map-platform.md)).
